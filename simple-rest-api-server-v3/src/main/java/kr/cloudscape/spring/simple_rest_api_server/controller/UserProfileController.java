...
public class UserProfileController {
    ...
    @Value("${hello.message: 반갑습니다}")  // application.properties 내 지정된 값. 없을 경우 '반갑습니다'는 디폴트 값 사용.
    ...
    public String getHello() {
        return helloMessage + " " + countries + " " + accountMap.get("name") + " " + accountMap.get("password");
    }
